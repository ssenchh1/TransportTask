...
namespace Transport
{
     class MinZatrataMethod
    {
        ...
        public static double CurrentSum = 0;
         public MinZatrataMethod(DataGridView _dataGridView,DataGridView _dataGridView2,Label label)
        {
            summa = label;
            ...
            for(int i = 0; i < dataGridView.RowCount-1; i++)
            {
                ...
                dataGridView2.Rows[i].Cells[dataGridView2.ColumnCount - 1].Value = need[i];
            }
            ...
            for(int i = 0; i < dataGridView.ColumnCount - 1; i++)
            {
                ...
                dataGridView2.Rows[dataGridView2.RowCount - 1].Cells[i].Value = stock[i];
            }
            //просто инициализируем goods и все подобное
        ...
        public static void FindSolution()
        {
            ...
            if (maxi == int.MaxValue && maxj == int.MaxValue)
            {
                ...
                isOptimal = true;
                summa.Text = "План оптималеню Стоимость перевозки: " + CurrentSum;
            }
            else
            {
